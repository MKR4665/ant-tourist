...
import { FaBus, FaShuttleVan, FaCarSide, FaTicketAlt } from 'react-icons/fa'
...
function App() {
  ...
  const [isAdminPanelView, setIsAdminPanelView] = useState(() => {
    if (typeof window === 'undefined') {
      return false
    }
    return isAdminPanelLocation(window.location)
  })
  ...
  useEffect(() => {
    ...
    const syncPathState = () => {
      setIsAdminPanelView(isAdminPanelLocation(window.location))
    }
    ...
    window.addEventListener('hashchange', syncPathState)
    window.addEventListener('locationchange', syncPathState)

    return () => {
      window.removeEventListener('popstate', syncPathState)
      window.removeEventListener('hashchange', syncPathState)
      window.removeEventListener('locationchange', syncPathState)
  ...
  const footerColumns = [
    ...
    {
      title: 'Our Services',
      links: ['Rent Bus', 'Rent Car', 'Rent Traveller / Mini Van', 'Book Bus Ticket', 'Popular Destination'],
    },
    {
      title: 'Book a Car',
      links: [
  ...
  const headerNavItems = [
    { label: 'HOME', href: 'https://anttravels.com/' },
    { label: 'BUS TICKET', href: 'https://anttravels.com/book-bus-tickets/' },
    { label: 'BUS HIRE', href: 'https://anttravels.com/bus-hire-in-delhi/' },
    { label: 'CAR HIRE', href: 'https://anttravels.com/car-rental-in-delhi/' },
    { label: 'TRAVELLER HIRE', href: 'https://anttravels.com/tempo-traveller-rental-in-delhi/' },
    { label: 'GALLERY', href: 'https://anttravels.com/gallery/' },
    { label: 'ONLINE PAYMENT', href: 'https://anttravels.com/online-payment/' },
    { label: 'CONTACT US', href: 'https://anttravels.com/contact-us/' },
  ]
  ...
  return (
    <>
      <header className="ant-figma-header">
        <div className="ant-figma-header-container">
          <a className="ant-figma-logo-link" href="https://anttravels.com/" target="_blank" rel="noreferrer">
            <img src={logoImage} alt="ANT Tourist" className="ant-figma-logo" />
          </a>

          <nav className="ant-figma-nav">
            <a href="#" className="ant-figma-nav-item">
              <FaBus className="ant-figma-nav-icon" />
              Rent Bus
            </a>
            <a href="#" className="ant-figma-nav-item">
              <FaShuttleVan className="ant-figma-nav-icon" />
              Rent Traveller
            </a>
            <a href="#" className="ant-figma-nav-item">
              <FaCarSide className="ant-figma-nav-icon" />
              Rent Car
            </a>
            <a href="#" className="ant-figma-nav-item">
              <FaTicketAlt className="ant-figma-nav-icon" />
              Bus Ticket
            </a>
          </nav>

          <div className="ant-figma-right">
            <div className="ant-figma-support-lang">
              <div className="ant-figma-support">
                <BiSupport className="ant-figma-support-icon" />
                Support
              </div>
              <div className="ant-figma-divider"></div>
              <div className="ant-figma-lang">
                <MdLanguage className="ant-figma-lang-icon" />
                EN
              </div>
            </div>

            <div 
              className="ant-figma-manage-booking-wrapper"
              onMouseEnter={() => setManageMenuOpen(true)}
              onMouseLeave={() => setManageMenuOpen(false)}
            >
              <button className="ant-figma-manage-btn">
                Manage Booking
                <IoChevronDownOutline className={`ant-figma-manage-arrow ${manageMenuOpen ? 'rotate' : ''}`} />
              </button>
              {manageMenuOpen && (
                <div className="ant-figma-manage-dropdown">
                  <a href="#">Show My Booking</a>
