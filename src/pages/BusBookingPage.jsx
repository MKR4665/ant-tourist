...
import { FaArrowRight, FaBusAlt, FaCalendarAlt, FaChevronDown } from 'react-icons/fa'
    ...
    <div className="min-h-screen bg-[#ececec] text-[#4D4D4D]">
      ...
      <main>
        ...
        <section className="bg-[#f6f7f7] px-4 pb-16">
          <div className="mx-auto grid w-full max-w-[1216px] gap-8 lg:grid-cols-[minmax(0,800px)_385px]">
            <div className="rounded-[24px] border-[0.4px] border-[#4D4D4D] bg-white p-5 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)] sm:p-8">
              ...
              <div className="grid gap-6">
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <SelectField label="Vehicle Type" value="AC Seater Buses" className="md:mt-2" />
                  <SelectField label="Vehicle Name" value="22 Seater Luxury Coach Hire" className="md:mt-2" />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    className="ml-auto block text-[12px] font-normal leading-5 text-[#4D4D4D]"
                  >
                    add another pickup
                  </button>
                </div>
            ...
            <aside className="space-y-4">
              <img
                src={busPreviewImage}
                alt="22 Seater Luxury Coach Hire"
