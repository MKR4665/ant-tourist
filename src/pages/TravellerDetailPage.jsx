...
import travellerInteriorImage from '../image/94c123df6b3a057c31c3425656f5fb6681762ebf.png'

const defaultTitle = 'Comfortable Traveller / Minivan Rental Service For Delhi To Jaipur Tour'
const galleryImages = [travellerImage, travellerInteriorImage, travellerImage, travellerInteriorImage, travellerInteriorImage]
const features = [
  { label: '12 Seats', icon: FaUsers },
...
export default function TravellerDetailPage() {
  ...
  const handleBookNow = () => {
    navigate('/rent-traveller/routes/view-buses/detail/book-now', { state: { pageTitle: title } })
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f7] text-[#4D4D4D]">
      ...
      <main>
        ...
        <section className="bg-[#f5f7f7] px-4 pb-12 pt-0">
          <div className="mx-auto grid w-full max-w-[1216px] gap-8 lg:grid-cols-[696px_530px] lg:items-start">
            <div>
              ...
              <div className="relative h-[250px] overflow-hidden rounded-[16px] bg-[#E2E8F0] shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] md:h-[391.5px]">
                <img
                  src={travellerImage}
                  alt="12 seater luxury force motor"
            ...
            <div className="pt-1 text-[#4D4D4D]">
              <h2 className="m-0 text-[24px] font-extrabold leading-[34px] text-[#444444] md:text-[28px]">
                12 Seater (2+2) Luxury Force Motor
              </h2>
